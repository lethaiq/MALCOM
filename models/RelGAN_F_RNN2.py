...
class RelGAN_F_RNN2(nn.Module):
    def __init__(self, embedding_dim, vocab_size, padding_idx, hidden_dim,
                 extract_grad_hook=None, gpu=False, dropout=0.2, dropout_content=0.95):
        super(RelGAN_F_RNN2, self).__init__()
        ...
        if extract_grad_hook != None:
            self.embeddings.register_backward_hook(extract_grad_hook)
        ...
        self.gru = nn.GRU(self.feature_dim*cfg.max_seq_len, hidden_dim, num_layers=2, bidirectional=True, dropout=0.5)
